...
const SLIDES = [
  {
    ...
    tag: "EXCLUSIVE",
    description:
      "A warrior's journey across war-torn lands — dubbed in pure DJ Afro style. Feel every blow, hear every word.",
    accent: "#e50914",
  ...
  },
  {
    ...
    tag: "DUBBED",
    description:
      "Love, betrayal, and music in the heart of Mumbai. The full Bollywood experience, now in Swahili.",
    accent: "#ff6b35",
  ...
  },
  {
    ...
    tag: "TRENDING",
    description:
      "East Africa's most gripping crime saga. Streets, secrets, and survival. Now streaming.",
    accent: "#00c8ff",
    kenBurns: "zoom-out",
  },
  {
    ...
    tag: "TOP RATED",
    description:
      "The legend that shook a continent. An epic war saga dubbed to perfection — only on DjAfro Cinema.",
    accent: "#ffd700",
  ...
  },
  {
    ...
    tag: "NEW",
    description:
      "When the city sleeps, the real stories begin. Nollywood's darkest thriller, fully dubbed.",
    accent: "#c084fc",
    kenBurns: "zoom-in-left",
  },
  {
    ...
    tag: "BLOCKBUSTER",
    description:
      "Sand, fire, and fury. A blockbuster war epic dubbed by the master himself — DJ Afro.",
    accent: "#fb923c",
    kenBurns: "zoom-out",
  },
];
